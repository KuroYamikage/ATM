                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jpfPIN, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
...
int pinReal = 1234;
    private void jbtnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnConfirmActionPerformed
        ...
        if (pin == pindb && deposit >=100 &&deposit<=200000){
            ...
            JOptionPane.showMessageDialog(this, "Less than the Minimum Withdrawal Limit Please Try Again");
        }else if(deposit>200000)
        {
            JOptionPane.showMessageDialog(this, "Exceeded the Maximum Deposit Limit Please Try Again.");
        }
            }else{
